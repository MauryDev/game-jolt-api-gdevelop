 ...
 */
function toScriptVariable(variable) {
    let script_variable = "runtimeScene.getVariables()";
    variable.split(".").forEach(function (val, index) {
        if (!index) {
            script_variable += ".get(\"" + val + "\")";
        } else {
            script_variable += ".getChild(\"" + val + "\")"
        }
    })
...
export { request, toScriptVariable }